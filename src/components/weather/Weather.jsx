...
export default function Weather() {
    ...
    } } = useGetStateQuery("weather.forecast_home_assistant")
    const weather = {
        state: "",
        icon: ''
    }
            ...
            <Box sx={{ display: "flex", alignItems: "center" }} >
                ...
                <Box sx={{
                    ...
                    <Box display="flex" pr={2}>
                        ...
                        <Typography variant='body1'>{data.attributes.temperature + " " + data.attributes.temperature_unit}</Typography>
                    </Box>
                </Box>
            </Box>
            <List>
                <ListItem sx={{ pt: 0, pb: 0 }}>
                    ...
                    <Typography variant="body1" width="60%" pr={2}>Atmospheric pressure</Typography>
                    <ListItemText primary={data.attributes.pressure} secondary={data.attributes.pressure_unit} />
                </ListItem>
                <ListItem sx={{ pt: 0, pb: 0 }}>
                    <ListItemIcon >
                        <WaterDropIcon />
                    </ListItemIcon>
                    <Typography variant="body1" width="60%" pr={2}>Humidity</Typography>
                ...
                <ListItem sx={{ pt: 0, pb: 0 }}>
                    ...
                    <Typography variant="body1" width="60%" pr={2}>Wind speed</Typography>
                    <ListItemText primary={data.attributes.wind_speed} secondary={data.attributes.wind_speed_unit} />
                </ListItem>
            </List>
        </Card>
    )
